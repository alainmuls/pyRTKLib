...
dOUTPUT['plot'] = {}
dOUTPUT['plot']['llh'] = ('lat', 'lon', 'ellH')
dOUTPUT['plot']['dENU'] = ('dN0', 'dE0', 'dU0')
dOUTPUT['plot']['sdENU'] = ('sdN', 'sdE', 'sdU')
dOUTPUT['plot']['xDOP'] = ('GDOP', 'PDOP', 'TDOP', 'HDOP', 'VDOP')
dOUTPUT['plot']['gnss'] = ('#SVs', '#GNSSs', 'GNSSs')
